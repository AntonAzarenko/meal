...
public class EmbeddedPostgresConfig {
    ...
    @Bean
    public SqlSessionFactoryBean embeddedSqlSessionFactory(ApplicationContext applicationContext) throws Exception {
        ...
        sqlSessionFactory.setDataSource(embeddedDataSource());
    ...
    public MapperFactoryBean<UserRepository> userRepository(ApplicationContext applicationContext) throws Exception {
        ...
        repository.setSqlSessionFactory(embeddedSqlSessionFactory(applicationContext).getObject());
        return repository;
    }
