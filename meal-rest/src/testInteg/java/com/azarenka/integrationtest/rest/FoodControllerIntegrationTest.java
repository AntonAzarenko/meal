...
public class FoodControllerIntegrationTest extends WebTests {
    ...
    public void getAll() {
        ...
        assertFoodResponses(expectedFoodResponse.stream().sorted().collect(Collectors.toList()),
            foodResponses.stream().sorted().collect(Collectors.toList()));
    }
    ...
    private List<FoodResponse> prepareExpectedFood() {
        List<FoodResponse> foodResponses = Arrays.asList(
            ...
            buildFoodResponse("Йогурт(н\\ж 0.1 -0.3%)", 0, 0, 0, 1, 120, "33a0499d-8469-4d2b-89fd-ebfe28669251",
                "граммов"),
            buildFoodResponse("Арахис стручковый", 0, 0, 0, 1, 6, "4ff161cf-9d8e-41c8-b79f-1eda156777c9", "штук")
        );
